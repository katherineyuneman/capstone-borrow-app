class Title < ApplicationRecord
  ...
  def self.available_book_count
    ...
    .select(
      'titles.title','titles.id', 'titles.rating','titles.image_url',
      'titles.genre', 'titles.author_id as author_id', 'titles.publication_date', 'count(books.rented) as count_available')
    .group(
        'titles.title','titles.id', 'titles.rating', 'titles.genre', 'titles.author_id', 'titles.publication_date', 'titles.image_url')
  end
